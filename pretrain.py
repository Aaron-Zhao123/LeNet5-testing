...
open_file_name = 'weights_quan.pkl'
...
print('-'*79)
print("Neural Network's preditiion of the first 64 images in the test set")
print(np.argmax(predict, axis = 1))
print('-'*79)
print("Actual value of the first 64 images in the test set")
